...
export const getProtocols = async (filters) => {
  ...
  const partesNombre = [];
  if (processedFilters.apellido_paciente) partesNombre.push(processedFilters.apellido_paciente.trim());
  if (processedFilters.patient_name) partesNombre.push(processedFilters.patient_name.trim());
  ...
  const hasStrongFilters = 
    (processedFilters.patient_id_number && processedFilters.patient_id_number.trim() !== '') || 
    (processedFilters.accession_number && processedFilters.accession_number.trim() !== '') || 
    (processedFilters.patient_name && processedFilters.patient_name.trim() !== '');
