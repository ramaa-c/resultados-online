...
import { FiX, FiSend, FiUser, FiHash, FiCalendar, FiMapPin } from "react-icons/fi";
...
export default function Email({ isOpen, onClose, protocolo }) {
    ...
    <div className="modal-overlay">
      <div className="modal-content">
        <div className="modal-header">
          <h3><FiSend /> Enviar Resultados por Email</h3>
  ...
  <div className="info-item full-width">
    <label><FiUser /> PACIENTE</label>
    <span>{protocolo.apellidopaciente}, {protocolo.nombrepaciente}</span>
  </div>
          ...
          <form className="email-form" onSubmit={handleSend}>
            <div className="input-group">
              ...
              <button 
                ...
                disabled={isSending} // Se deshabilita mientras envía
                >
                {isSending ? "Enviando..." : <><FiSend /> Enviar Ahora</>}
                </button>
          </form>

          <div className="recent-history">
            <h4>Envíos realizados</h4>
            <div className="empty-history">No hay envíos previos para este protocolo.</div>
          </div>
        </div>
      </div>
    </div>
